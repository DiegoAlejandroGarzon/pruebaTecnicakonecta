                ...
                <div class="card-body py-3">
                        <form class="was-validated" id="formularioBarrioEditar" enctype="multipart/form-data">
                            ...
                            <div class="mb-3">
                                ...
                                <input id="documento" name="documento" type="text" class="form-control bloqueo" required>
                            </div>
                            <div class="mb-3">
                            ...
                            <div class="mb-3">
                                ...
                                <input id="direccion" name="direccion" type="text" class="form-control bloqueo" required>
                            </div>
                        </form>
                    </div>
            </div>
...
<script rel="stylesheet" src="{{asset('js/vendedor/administrarCliente.js')}}"></script>
@endsection